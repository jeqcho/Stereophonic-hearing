# Biaural-model
This neural network program models how humans or animals determine the direction of the source of a sound using two ears. The model is trained using NEAT (NeuroEvolution of Augmenting Topologies)
